...
namespace module3dz
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Задача 10: Выделить квадратными скобками слова, начинающиеся и заканчивающиеся одной буквой
            ...
            // Задача 11: Обнулить элементы тех строк, на пересечении которых с главной диагональю стоит четный элемент
            ...
            // Задача 12: Обнулить элементы тех столбцов, на пересечении которых с главной диагональю стоит четный элемент
            for (int j = 0; j < cols; j++)
            {
                for (int i = 0; i < rows; i++)
                {
            ...
            // Задача 13: Удалить те столбцы, в которых встречается хотя бы два одинаковых элемента
            ...
            // Задача 14: Подсчитать количество пробелов во вводе до ввода точки
            int spaceCount = 0;
            char inputChar;
            do
            {
            ...
            // Задача 15: Проверить, является ли номер трамвайного билета счастливым
